...
export const saveEntry = async (value, entry = {}) => {
    ...
    try {
        ...
        console.error('saveEntry :: error on save object: ' + JSON.stringify(data), 'error: ', JSON.stringify(error))
...
export const deleteEntry = async (entry) => {
    ...
    try {
        ...
        console.error('deleteEntry :: error on delete object: ' + JSON.stringify(data), 'error: ', JSON.stringify(entry))
